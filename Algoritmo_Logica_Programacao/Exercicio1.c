...
int main(void) {
    ...
    while (opcao != 5) {
        ...
        do {
            ...
            if (opcao < 1 || opcao > 5) {
                printf("\nOp??o inv?lida. Por favor, escolha outra op??o.\n");
            } else {
                k = 1;
            }
        } while (k != 1);
        ...
        switch (opcao) {
            case 1:
                if (i < 7) {
                    ...
                    setbuf(stdin, NULL);
                    printf("\nNome: ");
                    scanf("%14s", cadastro[i].nome); // 14 para deixar espa?o para o terminador nulo
                    printf("\nIdade: ");
            ...
            case 2:
                if (i >= 0) {
                    ...
                    printf("\nEm qual ID est? o dado que deseja alterar? ");
                    scanf("%d", &altera);
                    altera = altera - 1;
                    ...
                    printf("\nNenhum cadastro dispon?vel para alterar.\n");
                }
                break;

            case 3:
                printf("\nO que voc? deseja pesquisar?\nDigite 1 para nome ou 2 para idade: ");
                scanf("%d", &pesquisa);
                ...
                if (pesquisa == 1) {
                    ...
                    if (incn == 0) {
                        printf("\n %s n?o consta no cadastro.", pnome);
                    } else {
                        if (incn == 1){
                    ...
                    if (inci == 0) {
                        printf("\n %d n?o consta no cadastro.", pidade);
                    } else {
                        if (inci == 1){
